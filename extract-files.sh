...
adb pull /system/usr/keylayout/a5-gpio-keypad.kl ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
...
PRODUCT_COPY_FILES += \\
    ...
    vendor/acer/__DEVICE__/proprietary/a5-gpio-keypad.kl:/system/usr/keylayout/a5-gpio-keypad.kl \\
